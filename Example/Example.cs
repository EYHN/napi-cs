...
namespace Example
{
  public class Example
  {
    ...
    {
      exports.Set(JsString.Create(scope, "plus"), JsFunction.Create(scope, "plus", (scope, @this, args) => JsNumber.Create(scope, ((JsNumber)args[0]).ToDouble() + ((JsNumber)args[1]).ToDouble())));
